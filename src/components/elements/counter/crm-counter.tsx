...
const CRMCounter = ({ counter }: Props) => {
  const { title, details, image1, items } = counter.data;
  ...
  return (
    <section
      id="about"
      className="pt-[60px] md:pt-[100px] lg:pt-[150px] xl:pt-[200px]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-[24px]">
          ...
          <div className="col-md-5 col-lg-7">
            <div
              ...
              className="aspect-[7/9] w-full bg-center bg-cover relative rounded-[40px] max-w-full lg:max-w-[430px] xl:max-w-[530px] 2xl:max-w-[630px] ms-[unset] lg:ms-auto ps-[54px] pe-[45px] pt-[50px] md:pt-[140px]"
            ></div>
          </div>
        </div>
      </div>
